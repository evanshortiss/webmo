...
export abstract class AbstractListener <WrappedDomEvent, BaseEvent> {
  ...
  constructor (protected listener: (data: WrappedDomEvent) => void, protected options: ListenerOptions = {}) {
   ...
   * @param e
   */
  protected abstract isChangeAboveThreshold (data: WrappedDomEvent|BaseEvent): boolean
